        ...
        6329: function (e, t, r) {
            ...
            function M(e) {
                ...
                function tile1() {
                    ...
                    if (!document.getElementById("icon5")) {
                        // Cria o elemento div para o card
                        const cardDiv = document.createElement("div");
                        cardDiv.id = "icon5"; // Define um id para o card
                ...
                function tile2() {
                    ...
                    // Verifica se o card já existe
                    if (!document.getElementById("icon6")) {
                        // Cria o elemento div para o card
                        const cardDiv = document.createElement("div");
                        cardDiv.id = "icon6"; // Define um id para o card
                        cardDiv.style.position = "fixed";
                ...
                function tile3() {
                    ...
                    // Verifica se o card já existe
                    if (!document.getElementById("icon7")) {
                        // Cria o elemento div para o card
                        const cardDiv = document.createElement("div");
                        cardDiv.id = "icon8"; // Define um id para o card
                        cardDiv.style.position = "fixed";
                        cardDiv.style.top = "47%";
                        ...
                        imgElement.alt = "Icon8"; // Adiciona texto alternativo para a imagem
                        imgElement.style.width = "100%"; // Garantir que a imagem preencha a largura do card
                        imgElement.style.height = "100%"; // Ajuste para preencher a altura
                ...
                function tile4() {
                    ...
                    // Verifica se o card já existe
                    if (!document.getElementById("icon9")) {
                        // Cria o elemento div para o card
                        const cardDiv = document.createElement("div");
                        cardDiv.id = "icon9"; // Define um id para o card
                        cardDiv.style.position = "fixed";
                        cardDiv.style.top = "47%";
                        cardDiv.style.left = "50%";
                        cardDiv.style.transform = "translate(-50%, -50%)"; // Centraliza o card
